                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`pl-10 bg-white/70 border-white/30 focus:bg-white focus:border-blue-400 transition-all duration-300 rounded-xl ${errors.login ? "border-red-400 focus:border-red-400" : ""
                            }`}
                          {...register("login")}
                        />
                      </div>
